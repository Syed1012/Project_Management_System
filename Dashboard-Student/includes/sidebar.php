            ...
            <div class="nav" style="padding-top: 10px; font-size: larger;">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="layout-static.html">Review's Status</a>
                        <a class="nav-link" href="layout-sidenav-light.html">Marks Allocated</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="layout-static.html">Group Chat</a>
                        <a class="nav-link" href="layout-sidenav-light.html">Global chat</a>
                    </nav>
                </div>
